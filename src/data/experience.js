...
const experience = [
  {
    ...
    positions: [
      ...
      },
      {
        ...
        description: "Converted the site's international home page from Polymer to React with support for 40 languages. Discovered and improved accessibility issues across our team's product. Contributed to our internal design system.",
      }
    ],
